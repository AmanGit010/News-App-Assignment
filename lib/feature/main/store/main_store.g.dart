...
mixin _$MainStore on _MainStoreBase, Store {
  late final _$isLoadingAtom =
      Atom(name: '_MainStoreBase.isLoading', context: context);
  ...
  late final _$isGridViewAtom =
      Atom(name: '_MainStoreBase.isGridView', context: context);
  ...
  void toggleGridView() {
    final _$actionInfo = _$_MainStoreBaseActionController.startAction(
        name: '_MainStoreBase.toggleGridView');
    try {
      return super.toggleGridView();
    } finally {
